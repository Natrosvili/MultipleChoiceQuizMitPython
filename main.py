...
if ant1 == "C" or ant1 == "c" or ant1 == "Xiaomi" or ant1 == "xiaomi":
    SCORE += 1
    print("Richtig!")
    print("Du hast: " + str(SCORE) + "/" + str(QUESTIONS) + " richtig.\n")
else:
...
if ant2 == "B" or ant2 == "b" or ant2 == "Acer" or ant2 == "acer":
    SCORE += 1
    print("Richtig!")
    print("Du hast: " + str(SCORE) + "/" + str(QUESTIONS) + " richtig.\n")
else:
...
if ant3 == "A" or ant3 == "a" or ant3 == "Python" or ant3 == "python":
    SCORE += 1
    print("Richtig!")
    print("Du hast: " + str(SCORE) + "/" + str(QUESTIONS) + " richtig.\n")
else:
...
if SCORE <= 1:
    ...
    print(str(SCORE) + "/" + str(QUESTIONS) + " -Ausreichend.")
else:
    print("Herzlichen Glückwünsch! Du hast " + str(SCORE) + "/" + str(QUESTIONS) + " richtig.")
